...
class PropelConvertConfTask extends AbstractPropelDataModelTask
{
     ...
     */
    public function setXmlConfFile($v)
    {
        $this->xmlConfFile = $v;
    }
    ...
    public function main()
    {
        ...
        if (!$this->xmlConfFile || !file_exists($this->xmlConfFile)) {
        ...
        $xmlDom->load($this->xmlConfFile);
        $xml = simplexml_load_string($xmlDom->saveXML());
        $phpconf = self::simpleXmlToArray($xml);
	    $this->log(sprintf('Loaded "%s" successfully', $this->xmlConfFile), \Project::MSG_VERBOSE);
        ...
        $output .= "// from XML runtime conf file " . $this->xmlConfFile . "\n";
        $output .= "\$conf = ";
